...
#define NV_MAX_RM_EXPORTED_OBJECTS (2)
...
typedef struct
{
    ...
    nv_aperture_t *regs;
    nv_aperture_t *dpaux[NV_DPAUX_NUM_DEVICES];
    nv_aperture_t *fb, ud;

    NvU32  interrupt_line;
    NvU32  dpaux_irqs[NV_DPAUX_NUM_DEVICES];
...
void       NV_API_CALL  nv_dma_cache_invalidate  (nv_state_t *, void *);

NvS32  NV_API_CALL  nv_start_rc_timer            (nv_state_t *);
NvS32  NV_API_CALL  nv_stop_rc_timer             (nv_state_t *);

void   NV_API_CALL  nv_post_event                (nv_state_t *, nv_event_t *, NvHandle, NvU32, NvU32, NvU16, NvBool);
...
NV_STATUS NV_API_CALL nv_export_rm_object_to_fd    (NvHandle, NvS32, NvU32, NvU32);
NV_STATUS NV_API_CALL nv_import_rm_object_from_fd  (NvS32, NvHandle *, NvU32);
...
BOOL       NV_API_CALL  rm_is_legacy_device      (NvU16, NvU16, NvU16, BOOL);
