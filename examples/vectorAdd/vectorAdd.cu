...
main(int argc, char *argv[])
{
	...
	ptr_A = cuio_load_floats("a.mem", n_elems, CUIO_MODE_READONLY);
	ptr_B = cuio_load_floats("b.mem", n_elems, CUIO_MODE_READONLY);
	ptr_C = cuio_load_floats("c.mem", n_elems, CUIO_MODE_WRITEONLY);
	...
	init_tickcount();
	vectorAdd<<<blocksPerGrid, N_THREADS>>>((float *)ptr_A.ptr_d, (float *)ptr_B.ptr_d, (float *)ptr_C.ptr_d, n_elems);
